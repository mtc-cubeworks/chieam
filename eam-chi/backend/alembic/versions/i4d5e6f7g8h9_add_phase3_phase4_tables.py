...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('incident', sa.String(50), sa.ForeignKey('incident.id'), nullable=True),
        ...
        sa.Column('analyst', sa.String(50), sa.ForeignKey('employee.id'), nullable=True),
    ...
    op.create_table(
        'corrective_action',
        sa.Column('id', sa.String(50), primary_key=True),
        sa.Column('failure_analysis', sa.String(50), sa.ForeignKey('failure_analysis.id'), nullable=True),
        sa.Column('action_type', sa.String(50), nullable=True),
        sa.Column('description', sa.Text, nullable=True),
        sa.Column('priority', sa.String(20), nullable=True),
        sa.Column('assigned_to', sa.String(50), sa.ForeignKey('employee.id'), nullable=True),
        sa.Column('due_date', sa.Date, nullable=True),
        sa.Column('completion_date', sa.Date, nullable=True),
        sa.Column('verification_date', sa.Date, nullable=True),
        sa.Column('verified_by', sa.String(50), sa.ForeignKey('employee.id'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('site', sa.String(50), sa.ForeignKey('site.id'), nullable=True),
        sa.Column('department', sa.String(50), sa.ForeignKey('department.id'), nullable=True),
        sa.Column('assigned_to', sa.String(50), sa.ForeignKey('employee.id'), nullable=True),
    ...
    op.create_table(
        'inspection_point',
        sa.Column('id', sa.String(50), primary_key=True),
        sa.Column('inspection_route', sa.String(50), sa.ForeignKey('inspection_route.id'), nullable=False),
        sa.Column('sequence', sa.Integer, nullable=True),
        sa.Column('asset', sa.String(50), sa.ForeignKey('asset.id'), nullable=True),
        sa.Column('location', sa.String(50), sa.ForeignKey('location.id'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('asset_class', sa.String(50), sa.ForeignKey('asset_class.id'), nullable=True),
        sa.Column('craft', sa.String(100), nullable=True),
        sa.Column('estimated_hours', sa.Float, nullable=True),
        sa.Column('estimated_cost', sa.Float, nullable=True),
        sa.Column('safety_procedures', sa.Text, nullable=True),
        sa.Column('checklist', sa.String(50), sa.ForeignKey('checklist.id'), nullable=True),
        sa.Column('active', sa.Boolean, default=True),
        sa.Column('created_at', sa.DateTime, nullable=True),
        sa.Column('updated_at', sa.DateTime, nullable=True),
    )
    ...
    op.create_table(
        'job_plan_task',
        sa.Column('id', sa.String(50), primary_key=True),
        sa.Column('job_plan', sa.String(50), sa.ForeignKey('job_plan.id'), nullable=False),
        sa.Column('sequence', sa.Integer, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('vendor', sa.String(50), sa.ForeignKey('vendor.id'), nullable=True),
        sa.Column('work_order', sa.String(50), sa.ForeignKey('work_order.id'), nullable=True),
    ...
    op.create_table(
        'meter_reading',
        sa.Column('id', sa.String(50), primary_key=True),
        sa.Column('meter', sa.String(50), sa.ForeignKey('meter.id'), nullable=False),
        sa.Column('reading_value', sa.Float, nullable=False),
        sa.Column('reading_date', sa.DateTime, nullable=True),
        sa.Column('delta', sa.Float, nullable=True),
        sa.Column('work_order', sa.String(50), sa.ForeignKey('work_order.id'), nullable=True),
        sa.Column('recorded_by', sa.String(50), sa.ForeignKey('employee.id'), nullable=True),
        sa.Column('notes', sa.Text, nullable=True),
