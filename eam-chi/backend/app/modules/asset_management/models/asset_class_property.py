...
class AssetClassProperty(BaseModel):
    """Asset Class Property entity model."""
    __tablename__ = "asset_class_property"
    ...
    default_value: Mapped[str] = mapped_column(String(255), nullable=True, default=None)
