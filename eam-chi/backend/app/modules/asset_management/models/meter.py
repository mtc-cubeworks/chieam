...
class Meter(BaseModel):
    ...
    last_reading_date: Mapped[datetime] = mapped_column(DateTime, nullable=True, default=None)
    rollover_point: Mapped[float] = mapped_column(Float, nullable=True, default=None)
    average_daily_usage: Mapped[float] = mapped_column(Float, nullable=True, default=None)
