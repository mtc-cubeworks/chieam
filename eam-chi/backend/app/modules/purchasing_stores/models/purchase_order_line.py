...
class PurchaseOrderLine(BaseModel):
    ...
    po_id: Mapped[str] = mapped_column(String(50), ForeignKey("purchase_order.id"), nullable=True, default=None)
    ...
    item_id: Mapped[str] = mapped_column(String(50), ForeignKey("item.id"), nullable=True, default=None)
