...
class ServiceContract(BaseModel):
    ...
    total_contract_value: Mapped[float] = mapped_column(Float, nullable=True, default=None)
    payment_terms: Mapped[str] = mapped_column(String(255), nullable=True, default=None)
    ...
    auto_renew: Mapped[bool] = mapped_column(Boolean, nullable=True, default=None)
    renewal_notice_days: Mapped[int] = mapped_column(Integer, nullable=True, default=None)
